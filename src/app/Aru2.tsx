...
<button onClick={handleAccept} disabled={inputsDisabled}>Accept Mission</button>
              <br/> <input 
                ...
                {inputsDisabled ?( mission!=="ARU"  ? ( <QuizC mission={mission} missionD={missionD} classe={classe} nome={name} cognome={last} extaT={inputsExtra} verifica={page}/>  ) : 
